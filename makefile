...
payloadTest.out: test/httpParserPayload_unitTest.cpp c/httpParserPayload.cpp
	g++ -Wno-write-strings -std=c++11 -g -O0 ./lib/libgtest_main.a ./lib/libgtest.a test/httpParserPayload_unitTest.cpp test/httpParserHeader_unitTest.cpp ./c/utils.c ./c/httpParserCommonUtils.c  -lpthread -o allTests.out
